...
import de.tobi1craft.concacity.client.entity.helper.HelperForesterRenderer;
...
public class ConcacityClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRendererRegistry.register(ModEntities.HELPER, HelperForesterRenderer::new);
    }
}
